...
#this is a quick start map without any point or shapefiles included. I have included just coastlines and bathymetry. See section 2.0 for including more map elements. 
...
sta_map_inset <- ggdraw() +
  ...
  draw_plot(inset, x = 0.735, y = 0.71, width = 0.24, height = 0.24)
...
# this map is designed for smaller spatial scales, and included more map elements. 
#this code requires the input of points as a csv. Here it is called  sta, (or stations). If you don't have stations you can instead just add a point as we did in the code chunk above. 
...
sta_map_inset <- ggdraw() +
  ...
  draw_plot(inset, x = 0.35, y = 0.70, width = 0.28, height = 0.28)
